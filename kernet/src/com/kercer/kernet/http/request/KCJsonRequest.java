 ...
 */
public abstract class KCJsonRequest<T> extends KCHttpRequest<T> {
    ...
    private final KCHttpResultListener<T> mListener;
    ...
    public byte[] getBody() {
        try {
            ...
            KCLog.wtf("Unsupported Encoding while trying to get the bytes of %s using %s",
