...
public final class KCEncodingUtils
{
	...
	public static byte[] getAsciiBytes(final String data)
	{
		...
		try
		{
			return data.getBytes(KCHttpDefine.US_ASCII);
		}
		catch (UnsupportedEncodingException e)
		{
	...
	/**
	 * Converts the byte array of ASCII characters to a string. This method is to be used when decoding content of HTTP elements (such as response
	 * headers)
	 *
	 * @param data
	 *            the byte array to be encoded
	...
	public static String getAsciiString(final byte[] data, int offset, int length)
	{
		...
		try
		{
			return new String(data, offset, length, KCHttpDefine.US_ASCII);
		}
		catch (UnsupportedEncodingException e)
		{
			throw new Error("HttpClient requires ASCII support");
