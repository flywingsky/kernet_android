 ...
 * {@link KCDelivery}. Cache misses and responses that require refresh are enqueued on the specified network queue for processing by a
...
public class KCCacheThread extends Thread
{
	 ...
	 */
	public KCCacheThread(BlockingQueue<KCHttpRequest<?>> cacheQueue, BlockingQueue<KCHttpRequest<?>> aNetworkQueue, KCCache aCache, KCDelivery aDelivery)
	{
