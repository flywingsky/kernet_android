 ...
 */
public class KCPoolingByteArrayOutputStream extends ByteArrayOutputStream {
    /**
     * If the {@link #PoolingByteArrayOutputStream(KCByteArrayPool)} constructor is called, this is
     * the default size to which the underlying byte array is initialized.
     */
    private static final int DEFAULT_SIZE = 256;

    private final KCByteArrayPool mPool;
     ...
     */
    public KCPoolingByteArrayOutputStream(KCByteArrayPool pool) {
     ...
     *        minimum size.
     */
    public KCPoolingByteArrayOutputStream(KCByteArrayPool pool, int size) {
        mPool = pool;
